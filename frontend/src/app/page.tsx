    ...
    <div className="min-h-screen bg-zinc-50 text-zinc-900 dark:bg-zinc-950 dark:text-zinc-50 relative overflow-hidden transition-colors duration-200">
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6 pt-20 pb-16 text-center space-y-8">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-zinc-200 dark:border-zinc-800 bg-white/80 dark:bg-zinc-900/60 backdrop-blur-sm shadow-sm">
          ...
          <span className="text-[10px] font-semibold text-zinc-600 dark:text-zinc-400 uppercase tracking-wider flex items-center gap-1">
        ...
        <div className="space-y-4 max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight leading-[1.1] bg-gradient-to-b from-zinc-900 via-zinc-800 to-zinc-700 dark:from-zinc-50 dark:via-zinc-100 dark:to-zinc-400 bg-clip-text text-transparent">
        ...
        <div className="pt-12 max-w-5xl mx-auto">
          <div className="relative rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white/40 dark:bg-zinc-900/10 p-2.5 backdrop-blur-md shadow-2xl glass-panel animate-fade-in">
            ...
            <div className="h-8 flex items-center justify-between px-3 border-b border-zinc-200/60 dark:border-zinc-800 bg-zinc-100/50 dark:bg-zinc-900/40 rounded-t-xl text-xs text-zinc-500">
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6 py-20 border-t border-zinc-200 dark:border-zinc-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Card 1 */}
          <div className="p-6 rounded-xl border border-zinc-200 dark:border-zinc-800/80 bg-white/40 dark:bg-zinc-900/5 backdrop-blur-sm space-y-4 hover:border-zinc-300 dark:hover:border-zinc-700 transition-all duration-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <ul className="space-y-3 pt-2 text-xs sm:text-sm text-zinc-700 dark:text-zinc-300">
              <li className="flex items-center gap-2">
                ...
                AI-Powered Semantic QA Chat and natural-language search
              </li>
              <li className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-emerald-500" />
                Auto-generated document summaries and smart tag categorization
              </li>
              <li className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-emerald-500" />
                Secure public shared landing pages with custom expiry boundaries
              </li>
              <li className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-emerald-500" />
              ...
              <li className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-emerald-500" />
                Built-in chunking logic for huge datasets up to 2GB each
              </li>
            </ul>
          </div>
          ...
          <div className="relative rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white/40 dark:bg-zinc-900/10 p-5 backdrop-blur-md">
            <div className="space-y-4 font-mono text-[11px] text-zinc-500 dark:text-zinc-400">
              <div className="flex items-center gap-2 text-blue-500 font-semibold border-b border-zinc-200 dark:border-zinc-800 pb-2">
      ...
      {/* FAQ / Technical Architecture Section */}
      <section className="relative z-10 max-w-4xl mx-auto px-6 py-20 border-t border-zinc-200 dark:border-zinc-900">
        <div className="text-center space-y-3 mb-12">
          <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-zinc-900 dark:text-zinc-100">
            Frequently Asked Questions
          </h2>
          <p className="text-sm text-zinc-500 dark:text-zinc-400">
            Understand the decentralized architecture and security layers of Fylo.
          </p>
        </div>

        <div className="space-y-6">
          <div className="p-5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white/40 dark:bg-zinc-900/5 backdrop-blur-sm space-y-2">
            <h4 className="text-sm font-semibold text-zinc-800 dark:text-zinc-200">
              How does Fylo achieve infinite, zero-subscription storage?
            </h4>
            <p className="text-xs text-zinc-500 dark:text-zinc-400 leading-relaxed">
              Fylo leverages the decentralized communication infrastructure of Telegram's secure MTProto data channels. By linking your own Telegram Bot credentials, Fylo uses private cloud channels as a secure, decentralized storage medium. This gives you absolute storage sovereignty with zero recurring subscription fees.
            </p>
          </div>
          ...
          <div className="p-5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white/40 dark:bg-zinc-900/5 backdrop-blur-sm space-y-2">
            ...
            <p className="text-xs text-zinc-500 dark:text-zinc-400 leading-relaxed">
              Yes, entirely. Your files stream directly between your browser and your own Telegram node channel databases. Fylo acts purely as a self-sovereign compiler and vector index engine; we do not host your file contents on our servers, and your access credentials remain encrypted locally on your system.
            </p>
          </div>

          <div className="p-5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white/40 dark:bg-zinc-900/5 backdrop-blur-sm space-y-2">
            <h4 className="text-sm font-semibold text-zinc-800 dark:text-zinc-200">
              What does the AI Document Intelligence feature do?
            </h4>
            <p className="text-xs text-zinc-500 dark:text-zinc-400 leading-relaxed">
              When a file is uploaded, Fylo's backend AI pipeline parses the document, extracts key contexts, and automatically generates abstract summaries and relevant metadata tags. Furthermore, it creates vector embeddings (stored in Qdrant) so you can chat directly with your document repository using semantic natural language search.
            </p>
          </div>

          <div className="p-5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white/40 dark:bg-zinc-900/5 backdrop-blur-sm space-y-2">
            <h4 className="text-sm font-semibold text-zinc-800 dark:text-zinc-200">
              Can I securely share files with external users?
            </h4>
            <p className="text-xs text-zinc-555 dark:text-zinc-400 leading-relaxed">
              Absolutely. You can generate secure public sharing links for any file. Each link can be configured with specific expiration times and a maximum download limit, making public access highly customizable and secure.
            </p>
          </div>
        </div>
      </section>
      ...
      <footer className="relative z-10 border-t border-zinc-200 dark:border-zinc-900/60 py-12 text-center text-xs text-zinc-400 font-medium">
        <div className="max-w-6xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-6">
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="hover:text-zinc-600 dark:hover:text-zinc-300 transition-colors flex items-center gap-1.5">
