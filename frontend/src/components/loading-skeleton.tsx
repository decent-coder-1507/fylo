...
export function FileRowSkeleton() {
  return (
    <div className="grid grid-cols-12 gap-4 py-3.5 px-4 border-b border-zinc-200 dark:border-zinc-800/60 items-center">
      ...
      <div className="col-span-2 flex justify-end">
        <div className="w-16 h-4 rounded shimmer-bg hidden sm:block" />
      </div>
      <div className="col-span-2 flex justify-end">
        <div className="w-24 h-4 rounded shimmer-bg hidden sm:block" />
      </div>
  ...
  return (
    <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white/30 dark:bg-zinc-900/10 overflow-hidden">
      <div className="grid grid-cols-12 gap-4 py-3 px-4 border-b border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-950/40">
        ...
        <div className="col-span-2 flex justify-end">
          <div className="w-12 h-4 rounded shimmer-bg hidden sm:block" />
        </div>
        <div className="col-span-2 flex justify-end">
          <div className="w-16 h-4 rounded shimmer-bg hidden sm:block" />
        </div>
        <div className="col-span-1 flex justify-end">
          <div className="w-6 h-4 rounded shimmer-bg" />
        </div>
      </div>
